*** Settings ***
Documentation    This is test case to Get Announcements
Resource        ${EXECDIR}/keyword/announcements/get_announcements.robot
Resource        ${EXECDIR}/variable/announcements/uri.robot
Library         DataDriver   ${EXECDIR}/data/announcements/csv/get_announcements.csv

Default Tags    dev
Force Tags      get_announcements
Test Teardown   API.End API Connection
Test Template   Get Announcements

*** Variables ***
${params}                           ${None}
${uri}                              ${uri_v2_announcements}

*** Test Cases ***
${test_number}-${test_type}-Get Announcements-${test_desc}        ${expected_http_status_code}
...
Get Announcements
    ...
    Run Keyword And Continue On Failure     Run Keyword If  '${response.status_code}'=='200'        User Compare Result For Get Announcements                 ${response}
