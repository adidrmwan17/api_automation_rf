*** Settings ***
Documentation    This is test case to Mission Polling Question Today
...
Default Tags    dev
Force Tags      get_mission_polling_question_today
Test Teardown   API.End API Connection
Test Template   Get Mission Polling Question Today
...
*** Test Cases ***
${test_number}-${test_type}-Get Mission Polling Question Today-${test_desc}        ${expected_http_status_code}

*** Keywords ***
Get Mission Polling Question Today
